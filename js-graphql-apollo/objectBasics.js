...
const resolvers = {
  ...
  Category: {
      ...
      products: (parent, args, context) => {
        const categoryId = parent.id // parent is the parent of the child (e.g, category is parent, products is child)
        return products.filter(product => product.categoryId === categoryId);
      }
  },
  Product: {
      category: (parent, args, context) => {
        const categoryId = parent.categoryId // in this case the parent is the Product
